...
{
public:
  explicit Wrap32( uint32_t raw_value ) : _raw_value( raw_value ) {}
  ...
  Wrap32 operator+( uint32_t n ) const { return Wrap32 { _raw_value + n }; }
  bool operator==( const Wrap32& other ) const { return _raw_value == other._raw_value; }
